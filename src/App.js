...
const BASE_URL =
	process.env.NODE_ENV === 'production'
		? 'https://my-json-server.typicode.com/daveobat8/phase-2-tour-project'
		: 'http://localhost:8000';
	...
	return (
		<div className="App">
			...
			<Routes>
				...
				<Route
					path="/destination"
					element={<Destination BASE_URL={BASE_URL} />}
				/>
				<Route
				...
				<Route
					path="/offers"
					element={<Offers BASE_URL={BASE_URL} />}
				/>
				<Route
					path="/userform"
					element={<Userform BASE_URL={BASE_URL} />}
				/>
